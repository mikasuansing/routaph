...
export default function DesignB() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f4ef', fontFamily: 'ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif' }}>
      {/* Nav */}
      <header style={{ background: '#fff', borderBottom: '1px solid #e8e3da', padding: '0 32px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ marginBottom: 40, textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#fff3ee', border: '1px solid #fcd9c8', borderRadius: 20, padding: '4px 12px', fontSize: 12, color: '#ff6b35', marginBottom: 16, fontWeight: 500 }}>
            <span>●</span> 2 corridors active
          </div>
          <h1 style={{ fontSize: 40, fontWeight: 800, letterSpacing: '-0.04em', color: '#1a1410', lineHeight: 1.05, marginBottom: 12 }}>
            Get there faster.
          </h1>
        ...
        {/* Planner */}
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e8e3da', padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.05)', marginBottom: 24 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#1a1410', marginBottom: 6 }}>From</label>
              <select value={from} onChange={e => setFrom(e.target.value)} style={{
                width: '100%', background: '#f7f4ef', border: '1.5px solid #e8e3da',
                borderRadius: 8, padding: '10px 12px', fontSize: 14, color: '#1a1410',
            ...
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#1a1410', marginBottom: 6 }}>To</label>
          ...
          <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 20 }}>
              {[
                ...
                <div key={s.label} style={{ background: '#fff', borderRadius: 12, border: '1px solid #e8e3da', padding: '18px 20px' }}>
            ...
            {/* Route card */}
            <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e8e3da', padding: 24 }}>
